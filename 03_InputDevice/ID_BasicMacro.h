...
#define GP_LEFTBTN          0 + GAMEPAD_BTN_OFFSET
#define GP_BOTTOMBTN        1 + GAMEPAD_BTN_OFFSET
#define GP_RIGHTBTN         2 + GAMEPAD_BTN_OFFSET
#define GP_TOPBTN           3 + GAMEPAD_BTN_OFFSET
#define GP_LEFTFORESHDBTN   4 + GAMEPAD_BTN_OFFSET
#define GP_RIGHTFORESHDBTN  5 + GAMEPAD_BTN_OFFSET
#define GP_LEFTBACKSHDBTN   6 + GAMEPAD_BTN_OFFSET
#define GP_RIGHTBACKSHDBTN  7 + GAMEPAD_BTN_OFFSET
#define GP_LEFTMENUBTN      8 + GAMEPAD_BTN_OFFSET
#define GP_RIGHTMENUBTN     9 + GAMEPAD_BTN_OFFSET
#define GP_LEFTSTICKBTN     10 + GAMEPAD_BTN_OFFSET
#define GP_RIGHTSTICKBTN    11 + GAMEPAD_BTN_OFFSET
#define GP_UPDIRBTN         12 + GAMEPAD_BTN_OFFSET
#define GP_UPRIGHTDIRBTN    13 + GAMEPAD_BTN_OFFSET
#define GP_RIGHTDIRBTN      14 + GAMEPAD_BTN_OFFSET
#define GP_DOWNRIGHTDIRBTN  15 + GAMEPAD_BTN_OFFSET
#define GP_DOWNDIRBTN       16 + GAMEPAD_BTN_OFFSET
#define GP_DOWNLEFTDIRBTN   17 + GAMEPAD_BTN_OFFSET
#define GP_LEFTDIRBTN       18 + GAMEPAD_BTN_OFFSET
#define GP_UPLEFTDIRBTN     19 + GAMEPAD_BTN_OFFSET
